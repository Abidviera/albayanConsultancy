...
export class LandingPageContainerComponent {
  ...
  detailedServices = [
    ...
    },
    {
      ...
      description:
        'Direct access to government services including Tasheel, AMER centers, and GDRFA for all immigration and labor-related transactions.',
      images: [
    ...
    },
    {
      ...
      description:
        'Medical fitness test typing and processing for employment and residence permits, coordinated with approved medical centers.',
      images: [
  ...
  expertise = [
    {
      ...
      description:
        'All our staff are certified and trained in UAE government procedures',
    },
    {
      icon: '⏰',
      title: 'Fast Turnaround',
      description:
        'Quick processing times with express services available for urgent requests',
    },
    {
      icon: '💼',
      title: 'Complete Solutions',
      description:
        'One-stop shop for all typing, translation, and PRO services',
    },
    {
      icon: '📈',
      title: 'Latest Updates',
      description:
        'Stay updated with latest government regulations and requirements',
    },
  ];
  ...
  faqs = [
    {
      ...
      answer:
        'Required documents typically include: valid passport copy, Emirates ID copy (if applicable), photographs, current visa copy, and sponsor documents. Specific requirements vary by visa type. Contact us for a detailed checklist.',
    },
    {
      question: 'How long does Emirates ID processing take?',
      answer:
        'Standard Emirates ID processing takes 3-5 working days after biometric completion. Express services are available for urgent requests.',
    },
    {
      question: 'Can you help with freezone company formation?',
      answer:
        'Yes! We process freezone licenses for Rakez, SAIF Zone, Dubai Free Zones, Ajman Free Zone, and other Emirates. We handle the complete process from name reservation to license issuance.',
    },
    {
    ...
    },
    {
      ...
      answer:
        'Yes, we provide complete assistance with opening corporate and personal bank accounts in major UAE banks for both mainland and freezone companies.',
    },
    {
      question: 'What mainland jurisdictions do you cover?',
      answer:
        'We process mainland licenses for Ajman, Dubai, and Sharjah Economic Departments with complete PRO support.',
    },
    {
      question: 'What are your working hours?',
      answer:
        'We are open Saturday to Thursday, 8:00 AM to 8:00 PM, and Friday 4:00 PM to 8:00 PM. Appointments available outside hours for urgent matters.',
    },
    {
      question: 'Do you offer promotional packages?',
      answer:
        'Yes, we have special packages for visa processing, business setup, and translation services. Check our Packages & Offers section for current promotions.',
    },
  ];
  ...
  uniqueServices = [
    {
      ...
      description:
        'We have direct access to Tasheel, AMER, GDRFA, and ICP systems for faster processing.',
    },
    {
      image:
        'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
      ...
      description:
        'Get expert advice on visa requirements, business setup, and documentation at no charge.',
    },
    {
      image:
        'https://images.unsplash.com/photo-1497366216548-37526070297c?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=1080',
      ...
      description:
        'Ongoing assistance for all documents processed through our center, even years later.',
    },
  ];
